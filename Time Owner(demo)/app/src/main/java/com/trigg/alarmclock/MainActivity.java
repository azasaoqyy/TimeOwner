...
public class MainActivity extends ActionBarActivity implements ActionBar.TabListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        //String job = logOrNot.getString("job", "");
...
////////////////////////////////////////////////////////////////////////////////////////////
    public class JsonTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            String job_test_url = "http://120.126.16.70/kai/bjt/job_test.php";
                ...
                builder.setItems(R.array.job_sel, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        switch(which){
                            case 0://選擇管理者
                                String job_m = "m";
                                SharedPreferences setting1 = getSharedPreferences("loginInfo", 0);
                                SharedPreferences.Editor editor1 = setting1.edit();
                                editor1.putString("job", job_m);
                                editor1.commit();
