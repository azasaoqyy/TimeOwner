...
public class AlarmDBHelper extends SQLiteOpenHelper {
	...
	//package
	private ContentValues populateContentPackage(String name) {
		ContentValues values = new ContentValues();
	...
	//package
	public long createPackage(String name) {
		ContentValues values = populateContentPackage(name);
	...
	//package
	public long updatePackage(String name,long id) {
		ContentValues values = populateContentPackage(name);
	...
	public int deletePackage(long id) {
		return getWritableDatabase().delete(Alarm.TABLE_NAME_P, Alarm._ID + " = ?", new String[] { String.valueOf(id) });
	}
}
